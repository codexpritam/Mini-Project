...
function History() {
  ...
  const fetchHistory = async () => {
    ...
    try {
      ...
      const expenseRes =
        await api.get("/api/expense")

      const incomeRes =
        await api.get("/api/income")
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-[1800px] mx-auto px-4 md:px-16 lg:px-24 py-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-x-auto">
          ...
          <table className="w-full min-w-[900px] md:min-w-[1250px]">

            <thead className="bg-slate-50 border-b border-slate-200">

              <tr className="text-left text-slate-500 text-sm">

                <th className="px-4 md:px-6 py-4 md:py-5">
                  Date
                </th>
                    ...
                    filteredTransactions.map(
                      (item) => (
                        ...
                        >
                          ...
                          <td className="px-4 md:px-6 py-4 md:py-5 text-slate-700">
                          ...
                          <td className="px-4 md:px-6 py-4 md:py-5 text-slate-800 font-medium">
                          ...
                          <td className="px-4 md:px-6 py-4 md:py-5 capitalize">
